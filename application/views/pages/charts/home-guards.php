...
<head>
    ...
    <?php
        foreach($booking_yhg as $data){
            $date[] = $data->month;
            $total[] = (float) $data->total;
        }

        foreach($income_yhg as $data1){
            $dat[] = $data1->month;
...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Home Guards</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>            
            <!-- /.row -->
            <div class="row">     
                <div class="col-lg-6">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Home Guards Daily Booking Chart
                        </div>
                        <!-- /.panel-heading -->    
                ...
                <div class="col-lg-6">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Home Guards Weekly Booking Chart
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="flot-chart">
                                <canvas id="hgbookweekly" width="400" height="300"></canvas>
                            </div>                            
                        </div>
                        <!-- /.panel-body -->
                    </div>
                ...
                <div class="col-lg-6">                
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Home Guards Monthly Booking Chart
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="flot-chart">
                                <canvas id="hgbookmonthly" width="400" height="300"></canvas>
                            </div>                            
                        </div>
                        <!-- /.panel-body -->
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Home Guards Yearly Booking Chart
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="flot-chart">
                                <canvas id="hgbookyearly" width="400" height="300"></canvas>
                            </div>
                        </div>
                        <!-- /.panel-body -->
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Home Gurads Daily Income Charts
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="flot-chart">
                ...
                <div class="col-lg-6">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Home Gurads Weekly Income Charts
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="flot-chart">
                                <canvas id="hgincomeweekly" width="400" height="300"></canvas>
                            </div>
                        </div>
                        <!-- /.panel-body -->
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Home Guards Monthly Income Charts
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="flot-chart">
                                <canvas id="hgincomemonthly" width="400" height="300"></canvas>
                            </div>
                        </div>
                        <!-- /.panel-body -->
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Home Gurads Yearly Income Charts
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="flot-chart">
                                <canvas id="hgincomeyearly" width="400" height="300"></canvas>
                            </div>
                        </div>
                        <!-- /.panel-body -->
                    </div>
